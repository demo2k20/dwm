...
static const unsigned int gappoh    = 32;        /* horizontal outer gap between windows and screen edge */
static const unsigned int gappov    = 32;        /* vertical outer gap between windows and screen edge */
